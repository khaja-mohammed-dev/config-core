...
/**
 * In-memory registry of running config-core instances, lease-based like Eureka: an instance is up
 * while its heartbeats keep arriving within the lease duration, shown as down once they stop, and
 * evicted after {@code config-admin.evict-after}. Instances re-register by themselves if the admin
...
public class InstanceRegistry {
    ...
    public InstanceRegistry(ConfigAdminProperties properties, Clock clock) {
